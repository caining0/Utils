...
import com.onlylady.beautyapp.activitys.LeShi.LetvParamsUtils;
...
import com.onlylady.beautyapp.fragments.PlagerFragment;
...
public class StartActivityUtils {
     ...
     * 乐视云活动直播
     */
    public static void startLeCloudActionLive(Context context, String id, String type, String liveid, String text) {
...
//                        StartActivityUtils.startLeCloudActionLive(context, id, type, laid, "直播尚未开始");
                        ...
                        StartActivityUtils.startLeCloudActionLive(context, id, type, laid, "直播已结束");
                    } else {//直播
                        StartActivityUtils.startLeCloudActionLive(context, id, type, laid, null);
                    }
